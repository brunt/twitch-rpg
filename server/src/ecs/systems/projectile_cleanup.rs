// src/ecs/systems/projectile_cleanup_system.rs (or adjust path as needed)

use specs::{Entities, Join, WriteStorage, System};
use crate::ecs::components::combat::FiredProjectile; // Adjust path to your FiredProjectile component
